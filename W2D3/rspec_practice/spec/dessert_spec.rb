...
describe Dessert do
  ...
  describe "#initialize" do
    ...
    it "raises an argument error when given a non-integer quantity" do
      expect { Dessert.new("cake", "pound", chef)}.to raise_error(ArgumentError)
    end
  end
  ...
  describe "#mix!" do
    it "shuffles the ingredient array" do
      ingredients = ["batter", "sprinkles", "frosting", "fruit", "fudge"]
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      ...
      expect(cake.serve).to eq("Chef Gordon the Great Baker has made 3 cakes!")
    end
  end
